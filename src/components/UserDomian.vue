<template>
  <div>
    ...
    <div class="form tw-mt-8">
      <h2>
        What would you like to call your blog site? By this name users will be
        able to identify your site.
      </h2>
      <div class="blog-name-input tw-mt-12">
        <v-text-field
          ...
          outlined
          counter
          :rules="[() => !!inputBlogName || 'This field is required']"
          required
        ></v-text-field>
        <!-- <input
          type="text"
      ...
      <div class="create-btn tw-mt-16">
        <v-btn block large color="black" dark @click="register">Create</v-btn>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    register() {
      ...
      this.$refs.inputBlogName.validate(true);
