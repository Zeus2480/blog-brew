  ...
  <div>
    ...
    <div class="">
      <v-bottom-sheet v-model="drawerMobile">
        <v-sheet class="text-center" height="85vh">
        ...
        <div class="tw-flex">
          <div>
            <div class="tw-flex tw-my-4">
              ...
              ></div>
              <h2 class="tw-my-auto tw-mx-4 tw-text-base tw-text-gray-600">
                {{ createdDate }}
              </h2>
            </div>
          </div>
        ...
        <div>
          <div class="like-comment-bar tw-flex tw-justify-between">
            <div class="tw-flex tw-my-5">
              <div class="tw-flex">
                <v-btn @click="likeUnlike" icon :color="likebtnColor">
                  <v-icon :color="likebtnColor">{{ likeBtnIcon }}</v-icon>
                </v-btn>
                <div class="">
            ...
            <div class="tw-my-auto">
              <v-btn :href="authorInstargram" v-if="authorInstargram" icon
...
export default {
  ...
  methods: {
    ...
    checkUserSubscribed() {
      axios
        .get(`/user/${this.userId}/is_subscribe`, {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        })
