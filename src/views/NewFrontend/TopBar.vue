  ...
  <div>
    <div class="tw-w-full tw-pt-5 tw-pb-5 tw-px-3 md:tw-px-24">
      <div class="tw-flex tw-justify-between">
        <div @click="pushToAllBlogs" class="title tw-flex tw-cursor-pointer">
          <img
            :src="authourImageUrl"
        ...
        <div class="tw-w-[250px] md:tw-w-[500px]">
          <v-text-field
            label="Search"
        ...
        <div class="tw-flex">
          <div class="tw-hidden md:tw-flex">
            ...
            <div class="tw-flex tw-ml-3 tw-my-auto tw-flex-row-reverse">
              ...
              >
              <v-btn v-if="authourFacebookUrl" :href="authourFacebookUrl" icon
                ><v-icon>mdi-facebook</v-icon></v-btn
              >
              <v-btn v-if="authourInstagramUrl" :href="authourInstagramUrl" icon
            ...
            >
              ...
              <v-card>
                <div v-if="!isUserLoggedIn" class="">
                  <div class="tw-bg-gray-200 tw-border-2 tw-border-gray-200">
                  ...
                  <div class="tw-p-6 tw-pb-4">
                    ...
                    <div class="tw-my-2 tw-mb-4">
                      <p class="tw-text-center tw-text-gray-500 tw-text-base">
                        Don't miss my next atricles sign in with a webook
                        account.
                      </p>
                    </div>
                    <v-divider></v-divider>
                    ...
                    >
                      ...
                      <h1 class="tw-mx-4 tw-text-lg tw-my-auto">Login</h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="tw-p-6 tw-pb-4">
                    <div class="tw-mb-4">
                      ...
                      <div class="tw-ml-2">
                        ...
                        <p class="tw-text-sm tw-text-center tw-text-gray-400">
                          {{ user.email }}
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <h1 class="tw-mx-4 tw-text-lg tw-my-auto">Log out</h1>
                    </div>
                  </div>
                </div>
              </v-card>
  ...
  methods: {
    ...
    getAuthorDetails() {
      if (!this.$store.getters.getSite) {
        axios.get(`/user/${this.$route.params.userId}/profile`).then((res) => {
          let tempObject = {
